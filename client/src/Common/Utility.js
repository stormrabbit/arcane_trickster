export default class Utility {
  ...
  constructor() {
    ...
    this.__ConstPrefix = 'WeiXinExodus';
  }
  ...
  static constItem = {
     ...
     * 当前的上下文
     */
    Context: 'ExodusContext',                                             // 当前页面的Context
    ReduxKey: {
      ManualInputModify: 'ManualInputModify',
    },
    NavBarRightType: { NBDefault: 'NBDefault', NBButton: 'NBButton', NBIcon: 'NBIcon', NBMenu: 'NBMenu' },
    /**
     * 事件
     */
    Event: 'onExodusEvent',                                               // 事件。
    Events: {
      HttpStatus: {
        1: 'onHttpStatus_Exodus_1',
        200: 'onHttpStatus_Exodus_200',                  // 处理成功
        400: 'onHttpStatus_Exodus_400',                  // 请求无效
        401: 'onHttpStatus_Exodus_401',                  // 未授权访问
        402: 'onHttpStatus_Exodus_402',
        403: 'onHttpStatus_Exodus_403',                  // 禁止访问
        404: 'onHttpStatus_Exodus_404',                  // 资源未找到
        405: 'onHttpStatus_Exodus_405',
        406: 'onHttpStatus_Exodus_406',
        407: 'onHttpStatus_Exodus_407',
        408: 'onHttpStatus_Exodus_408',
        409: 'onHttpStatus_Exodus_409',
        411: 'onHttpStatus_Exodus_411',                   // 登陆超时
        500: 'onHttpStatus_Exodus_500',                   // 服务器错误
        501: 'onHttpStatus_Exodus_501',
        502: 'onHttpStatus_Exodus_502',
        503: 'onHttpStatus_Exodus_503',
      },
      ShowModel: {
        OnActionSheet: 'onExodus_ShowModel_ActionSheet',                            //
        OnLoading: 'onExodus_ShowModel_Loading',                                    // 加载
        OnAlert: 'onExodus_ShowModel_Alert',                                        // 弹出信息
        OnConfirm: 'onExodus_ShowModel_Confirm',                                    // 确定--取消
        OnShowDialog: 'onExodus_ShowModel_ShowDialog',                              // 打开对话框
        OnShowDialogHide: 'onExodus_ShowModel_ShowDialogHide',                      // 隐藏对话框
        OnShowDialogClose: 'onExodus_ShowModel_ShowDialogClose',                    // 关闭对话框
        OnActionSheetHide: 'onExodus_ShowModel_ActionSheetHide',                    // 关闭
        OnLoadingHide: 'onExodus_ShowModel_LoadingHide',
        OnConfirmHide: 'onExodus_ShowModel_ConfirmHide',
      },
    ...
    UserInfo: 'Exodus_UserInfo',                                                    // 用户信息
    SaveUserConfigInfo: 'Exodus_SaveUserConfigInfo',                                // 保存用户获取的配置信息
    SaveUrlPath: 'Exodus_SaveUrlPath',                                              // url保存地址
    /**
     * 所有接口常量
     */
    API: {
      UserInfo: 'Exodus_API_UserInfo',    // 用户信息
    },
     ...
     */
    SavePageInfo: {
      NewSubTask: 'Exodus_SavePageInfoNewSubTask',                                // 子任务
    },
    /**
    * url 列表
    */
     ...
     */
    ShowModel: {
      ActionSheet: 'ExodusShowModelActionSheet',                      //
      Loading: 'ExodusShowModelLoading',                              // 加载
      Alert: 'ExodusShowModelAlert',                                  // 弹出信息
      Confirm: 'ExodusShowModelConfirm',                              // 确定--取消
    },
    /**
     * 所有状态的
     */
