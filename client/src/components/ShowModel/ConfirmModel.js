...
import { Utility, VepIcon } from 'components';
...
export default class ConfirmModel extends Component {
  ...
  render() {
    ...
    const { IsHideCancel, IsHideOk, IsMaxWidth, ChildrenIsComponent, StyleName } = Options || {};
    return (
          ...
          <div className={styles.subLeiLong + ' ' + (!!isShowAction ? styles.showAction : '') + ' '
            + (!!IsMaxWidth ? styles.isMaxWidth : '') + ' ' + styles[StyleName]}>
            {
              ...
              <div className={styles.closeIcon} ref="divClose" >
                <VepIcon ref="divCloseIcon" IconType="iconDelete10" onClick={this.__HandlerCancelButton.bind(this, true)} />
              </div>
            }
            {
            ...
            <div ref="divTemplate" className={styles.template}>{
